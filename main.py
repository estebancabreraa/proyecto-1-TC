...
f = Digraph('Automata Finito No Determinista', filename='resultados/AFN'+str(random.random()))
...
afd = afn_a_afd.convert_afd_nodo(afn, dStates, dTrans)
...
f = Digraph('Automata Finito Determinista', filename='resultados/AFD'+str(random.random()))
f.attr(rankdir='LR', size='8,5')
...
# Generar diagrama AFD
f = Digraph('Automata Finito Determinista (Directa)', filename='resultados/AFD_Directa'+str(random.random()))
f.attr(rankdir='LR', size='8,5')
...
f = Digraph('Automata Finito Determinista (Minimizado)', filename='resultados/AFD_Minimizado'+str(random.random()))
f.attr(rankdir='LR', size='8,5')
